...
\lstdefinelanguage{Spatial}{
  ...
  commentstyle=\color{codeorange}, %\bfseries,
  ...
  keywords=[5]{StreamIn, StreamOut, DRAM, ArgIn, ArgOut, HostIO, RegFile, Reg, SRAM, FIFO, FILO, LUT, LineBuffer},
  ...
  morekeywords={Foreach,Reduce,MemReduce,MemFold,Fold,Accel,Stream,FSM,Sequential,if,else,Parallel,Pipe}
}
...
\lstdefinelanguage{SpatialTable}{
  ...
  basicstyle=\fontsize{8}{8}\selectfont\tt,
  framesep=2pt,
  framerule=0pt,
  tabsize=2,
  %basewidth={0.0em, 0.0em}, % {0.54em, 0.4em},%
  numbers=none,
  showspaces=false,  
  keywordstyle=\bfseries,   
  breaklines=true,
  columns=fixed,
  xleftmargin=0.0in, %0.25in, 
  firstnumber=auto,
  showstringspaces=false,
  escapechar=@,
  escapeinside={(*@}{@*)},
  ...
  keywords=[7]{until, par, by},
  keywordstyle=\color{magenta}\bfseries,
  morekeywords={Foreach,Reduce,MemReduce,MemFold,Fold,Accel,Stream,FSM, if, else, Parallel, Pipe,Sequential, [, ] }
}
...
\lstdefinelanguage{SpatialTable}{
  ...
  keywords=[7]{until, par, by},
  keywordstyle=\color{magenta}\bfseries,
  morekeywords={Foreach,Reduce,MemReduce,MemFold,Fold,Accel,Stream,FSM, if, else, Parallel, DummyPipe, Pipe,Sequential, [, ] }
}
...
\end{center}
\vfill
\noindent \textbf{Author} \hfill \textbf{August 17, 2017} \\
Ruben Fiszel \\
\textit{$email$} \\
\vspace{0.5cm}
...
\noindent
\includegraphics[width=0.27\textwidth]{epfl-logo.eps}
\hfill
\includegraphics[width=0.4\textwidth]{stanford-logo.eps}
